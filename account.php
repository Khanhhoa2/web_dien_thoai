				...
				<div class="col-md-6">
					...
					<form name="form1" id="ff1" method="POST" action="#">
						<div class="form-group">
							<input type="email" class="form-control" placeholder="Email :" name="txtus" required value="hoqton@gmail.com">
						</div>
						<div class="form-group">
							<input type="password" class="form-control" placeholder="Mật khẫu :" name="txtem"required value="01207524430">
						</div>
